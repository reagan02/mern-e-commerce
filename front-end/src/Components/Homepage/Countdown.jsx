  ...
  return (
    <div className="flex xs:ml-12 sm:ml-20 ">
      <div className="flex flex-row  items-center ">
        ...
        <p className="text-orange-700 items-center font-bold px-1 sm:px-4 xs:text-sm text-xl">
          :
        </p>
      </div>
      ...
      <div className="flex flex-row ml-1 items-center">
        ...
        <p className="text-orange-700 items-center font-bold sm:px-1 xs:text-sm md:text-xl">
          :
        </p>
      </div>
