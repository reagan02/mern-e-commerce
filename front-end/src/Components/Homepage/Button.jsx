...
export const ViewButton = () => {
	return (
		<div className=" text-white bg-custom-red xs:py-2 md:py-3 lg:px-16 md:px-12 sm:px-10 xs:px-6 md:text-base xs:text-sm">
			View All Products
		</div>
	);
};
...
export const ViewButton2 = () => {
	return (
		<div className="text-white bg-custom-red xs:text-sm sm:text-base xs:px-4 xs:py-2 sm:px-8 sm:py-2 md:px-10 md:py-3 rounded ">
			View All
		</div>
	);
};
